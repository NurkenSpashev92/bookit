...
func (r *CountryRepository) Create(ctx context.Context, req schemas.CountryCreateRequest) (models.Country, error) {
	var c models.Country
...
func (r *CountryRepository) Update(ctx context.Context, id int, req schemas.CountryUpdateRequest) (models.Country, error) {
