...
// @Accept       json
// @Produce      json
// @Param        booking body schemas.BookingCreateRequest true "Booking data"
// @Success      201 {object} schemas.BookingResponse
...
func (h *BookingHandler) Create(c fiber.Ctx) error {
	...
	var req schemas.BookingCreateRequest
	...
	if err != nil {
		if errors.Is(err, services.ErrBookingOverlap) {
...
// @Tags         Bookings
// @Produce      json
// @Success      200 {array} schemas.BookingResponse
// @Failure      401 {object} schemas.ErrorResponse
// @Failure      500 {object} schemas.ErrorResponse
// @Security     ApiKeyAuth
// @Router       /bookings [get]
func (h *BookingHandler) GetMyBookings(c fiber.Ctx) error {
	...
	if bookings == nil {
		bookings = []schemas.BookingResponse{}
	}
...
// @Success      200 {object} schemas.BookingResponse
// @Failure      401 {object} schemas.ErrorResponse
...
// @Produce      json
// @Param        id path int true "Booking ID"
// @Param        body body schemas.BookingUpdateStatusRequest true "New status"
...
func (h *BookingHandler) UpdateStatus(c fiber.Ctx) error {
	...
	var req schemas.BookingUpdateStatusRequest
	if err := json.Unmarshal(c.Body(), &req); err != nil {
		return c.Status(400).JSON(schemas.ErrorResponse{Error: err.Error()})
	}
	if err := req.Validate(); err != nil {
	...
	if err := h.bookingService.UpdateStatus(c.Context(), id, user.ID, req.Status); err != nil {
		return c.Status(403).JSON(schemas.ErrorResponse{Error: err.Error()})
	}

	return c.JSON(schemas.MessageResponse{Message: "status updated"})
}
